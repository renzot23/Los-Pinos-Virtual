...
<div id="main">
	<div id="submain">
		<div class="actions">
			<a href="/chamilo/main/dashboard/index.php?view=list">
				<img src="http://localhost:3001/chamilo/main/img/icons/32/edit.png" alt="Editar bloques" title="Editar bloques">
			</a>
			<a href="http://localhost:3001/chamilo/main/admin/settings.php?category=Plugins">
				<img src="http://localhost:3001/chamilo/main/img/icons/32/settings.png" alt="Configurar el plugin del Panel de control" title="Configurar el plugin del Panel de control">
			</a>
		</div>
		<div style="margin-top:20px">No esta habilitado el panel de control</div>
		<a href="#">Configurar el Panel de control</a>
