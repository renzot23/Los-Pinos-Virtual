	...
	<div id="submain">
		<div id="social-content">
			...
			<div id="social-content-right">
				<div class="actions">
					<a href="">
						<img src="http://localhost:3001/tesiss/main/img/icons/32/compose_message.png" alt="Redactar" title="Redactar">
					</a>
					<a href="">
						<img src="http://localhost:3001/tesiss/main/img/icons/32/outbox.png" alt="Bandeja de salida" title="Bandeja de salida">
					</a>
				</div>
