	...
	<div id="submain">
		<div class="maincontent" id="maincontent">
			...
			<div class="userportal-course-item">
				...
				<a href="#">
					<img title="-- Documento -- Desde su última visita: visible (26/10/2011 19:08)." src="http://localhost:3001/chamilo/main/img/folder_document.gif" border="0" align="absbottom">
				</a>&nbsp;
			</div>
		</div>
		<div id="menu-wrapper">
