...
<div id="main">
	<div id="submain">
		<div id="content" class="maincontent">
			<p>
				<img width="300" height="283" alt="" src="/chamilo/home/default_platform_document/263505_10150216333972572_557687571_7359009_6629135_n_1.jpg">
			</p>
		</div>
		<div id="menu-wrapper">
			<div id="menu" class="menu">
				<div class="menusection  ">
					...
					<div class="message-content">
						<ul class="menulist">
							<li>
								<a href="red/mensajes.php" class="message-body">Bandeja de entrada </a>
							</li>
							<li>
								<a href="#" class="message-body">Redactar </a>
							</li>
							<li>
								<a href="#" class="message-body">Alumnos Pendientes  </a>
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="menu" id="menu">
				<div class="menusection">
					<span class="menusectioncaption">Usuario</span>
						<ul class="menulist">
							<li>
								<a href="admin_cursos.php">Catálogo de cursos</a>
							</li>
						</ul>
				</div>
			</div>
