...
require_once '../main/inc/apoderado/portal_apoderado.class.php';

$portal = new PortalApoderado();
...
<div id="header">
	<div id="header1">
		...
		<div id="logo">
			...
			<img title="INE Los Pinos - Los Pinos" src="<?php echo $_configuration['root_web']; ?>main/css/tesis/images/header-logo.png" alt="INE Los Pinos - Los Pinos">
			</a>
		</div>
			...
			<div id="menu" class="menu">
				<div class="menusection  ">
					...
					<div class="message-content">
						<ul class="menulist">
							<li>
								<a href="http://localhost:3001/tesiss/main/messages/inbox.php?f=social" class="message-body">Bandeja de entrada </a>
							</li>
							<li>
								<a href="http://localhost:3001/tesiss/main/messages/new_message.php?f=social" class="message-body">Redactar </a>
							</li>
							<li>
								<a href="http://localhost:3001/tesiss/main/social/invitations.php" class="message-body">Invitaciones pendientes  </a>
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="menu" id="menu">
				<div class="menusection">
					<span class="menusectioncaption">Usuario</span>
						<ul class="menulist">
							<li>
								<a href="main/auth/courses.php">Catálogo de cursos</a>
							</li>
						</ul>
				</div>
			</div>
